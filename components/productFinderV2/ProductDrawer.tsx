...
import { X, Zap, ShoppingBag, Save } from 'lucide-react';
        ...
        <div className="fixed inset-y-0 right-0 w-full lg:w-[800px] bg-slate-950 border-l border-slate-800 z-50 shadow-2xl overflow-y-auto animate-in slide-in-from-right duration-300 custom-scrollbar">
            ...
            <div className="p-6 space-y-8">
                ...
                <div className="flex gap-4 sticky bottom-6">
                    ...
                    <button className="flex-1 bg-slate-800 hover:bg-slate-700 text-white py-4 rounded-xl font-bold transition-all border border-slate-700">
                        Generate Report
                    </button>
                </div>
            </div>

...
import { Package, Briefcase, CheckCircle2, ArrowRight, Rocket, X, Link as LinkIcon } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl w-full">
        ...
        <div className="glass-panel p-8 md:p-12 rounded-3xl border border-white/10 shadow-2xl min-h-[400px] flex flex-col">
            ...
            {/* STEP 3: Details (If Yes) or Skip (If No) */}
            {step === 3 && (
                    ...
                    {hasItem ? (
                        ...
                        <div className="text-center max-w-lg mx-auto py-10">
                            ...
                            <p className="text-slate-400">
                                We will redirect you to the {model === BusinessModel.DROPSHIPPING ? 'Product Finder' : 'Idea Finder'} to discover your next winner using real-time market data.
                            </p>
                        </div>
                    )}
                </div>
